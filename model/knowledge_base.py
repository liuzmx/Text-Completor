...
class LocalKnowledgeBase:
    ...
    def __init__(self, conf: dict = CONFIG) -> None:
        self.conf = conf
        self.client = MilvusClient(f"{conf['local_knowledge_base']['local_dir']}/{conf['local_knowledge_base']['db']}")
        self.collection_name = conf["local_knowledge_base"]["collection_name"]
